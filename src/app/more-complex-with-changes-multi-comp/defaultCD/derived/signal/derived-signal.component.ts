...
import { ListItemSignalComponent } from '../../../list-item-signal.component';

@Component({
  selector: 'app-derived-signal-default-CD-with-changes-multi-component',
  imports: [TestArea, ListItemSignalComponent],
  template: `
    <app-test-area>
      <span #txt>derived-signal-default-cd-advanced-with-changes-multi-component: 
      ...
      <app-list-item-signal [inputVal]="signal1()" />
    </app-test-area>
  `,
})
export class DerivedSignalDefaultCDAdvancedWithChangesMulticomponent {
  signal1 = signal(123)
  signal2 = signal(456)
  signal3 = signal('abc')
  signal4 = signal('def')
