...
import { ListItemObservableComponent } from '../../../list-item-observable.component';

@Component({
  selector: 'app-derived-observable-default-CD-with-changes-multi-component',
  imports: [TestArea, AsyncPipe, ListItemObservableComponent],
  template: `
    <app-test-area>
      <span #txt>derived-observable-default-cd-advanced-with-changes-multi-component: 
...
export class DerivedObservableDefaultCDAdvancedWithChangesMulticomponent  {
