...
@Component({
  selector: 'app-derived-observable-onpush-CD-with-changes-multi-component',
  imports: [TestArea, AsyncPipe, ListItemObservableComponent],
  template: `
    <app-test-area>
      <span #txt>derived-observable-onpush-CD-advanced-with-changes-multi-component: 
...
export class DerivedObservableOnpushCDAdvancedWithChangesMulticomponent  {
