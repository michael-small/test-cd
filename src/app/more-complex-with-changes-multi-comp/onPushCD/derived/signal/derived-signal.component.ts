...
@Component({
  selector: 'app-derived-signal-onpush-CD-with-changes-multi-component',
  imports: [TestArea, ListItemSignalComponent],
  template: `
    <app-test-area>
      <span #txt>derived-signal-onpush-CD-advanced-with-changes-multi-component: 
...
export class DerivedSignalOnpushCDAdvancedWithChangesMulticomponent  {
  signal1 = signal(123)
  signal2 = signal(456)
  signal3 = signal('abc')
  signal4 = signal('def')
