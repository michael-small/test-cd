...
@Component({
  selector: 'app-derived-signal-default-CD-with-changes-2',
  imports: [TestArea],
  template: `
    <app-test-area>
      <span #txt>derived-signal-default-cd-advanced-with-changes-2: 
...
export class DerivedSignalDefaultCDAdvancedWithChanges2 {
  signal1 = signal(123)
  signal2 = signal(456)
  signal3 = signal('abc')
  signal4 = signal('def')
