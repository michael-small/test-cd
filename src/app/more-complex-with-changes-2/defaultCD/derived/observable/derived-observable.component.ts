...
@Component({
  selector: 'app-derived-observable-default-CD-with-changes-2',
  imports: [TestArea, AsyncPipe],
  template: `
    <app-test-area>
      <span #txt>derived-observable-default-cd-advanced-with-changes-2: 
...
export class DerivedObservableDefaultCDAdvancedWithChanges2 {
