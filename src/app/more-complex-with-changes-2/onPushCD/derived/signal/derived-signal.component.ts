...
@Component({
  selector: 'app-derived-signal-onpush-CD-with-changes-2',
  imports: [TestArea],
  template: `
    <app-test-area>
      <span #txt>derived-signal-onpush-CD-advanced-with-changes-2: 
...
export class DerivedSignalOnpushCDAdvancedWithChanges2 {
  signal1 = signal(123)
  signal2 = signal(456)
  signal3 = signal('abc')
  signal4 = signal('def')
