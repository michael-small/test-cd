...
@Component({
  selector: 'app-derived-observable-onpush-CD-with-changes-2',
  imports: [TestArea, AsyncPipe],
  template: `
    <app-test-area>
      <span #txt>derived-observable-onpush-CD-advanced-with-changes-2: 
...
export class DerivedObservableOnpushCDAdvancedWithChanges2 {
