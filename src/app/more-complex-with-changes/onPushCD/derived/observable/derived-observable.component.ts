...
@Component({
  selector: 'app-derived-observable-onpush-CD-with-changes',
  imports: [TestArea, AsyncPipe],
  template: `
    <app-test-area>
      <span #txt>derived-observable-onpush-CD-advanced-with-changes: 
...
export class DerivedObservableOnpushCDAdvancedWithChanges {
